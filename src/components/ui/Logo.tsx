...
import Svg, { Circle, Rect, Defs, LinearGradient, Stop, G, Path, Text as SvgText } from 'react-native-svg';
...
const Logo: React.FC<LogoProps> = ({ size = 120, showText = true }) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 500 500">
      ...
      <Defs>
        <LinearGradient id="grad1" x1="70" y1="200" x2="430" y2="200" gradientUnits="userSpaceOnUse">
