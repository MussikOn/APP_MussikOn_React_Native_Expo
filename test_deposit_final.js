...
async function testDepositFinal() {
  try {
    console.log('🧪 Prueba final del endpoint de depósito con archivo válido...\n');
    ...
    formData.append('description', 'Depósito de prueba final con imagen válida');
    ...
    console.log('- description: Depósito de prueba final con imagen válida');
